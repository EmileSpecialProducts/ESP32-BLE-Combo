// this is a copy of the <class/hid/hid.h> from the ESP32-S3
// But we do need the KeyCodes for the BLT

#ifndef _TUSB_KEYS_HID_H_
#define _TUSB_KEYS_HID_H_
